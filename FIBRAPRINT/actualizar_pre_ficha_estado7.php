...
$observaciones=$_POST['obs_pre_ret'];


if ($tipouser=="1"){
    $cadena2="UPDATE [dbo].[@INCODEMOB_PREFICHA]  SET estado='01' , fecha_matprint= '$fecha'  WHERE  num_ficha='$num_ficha'" ;
...
if( $exec2 === false ){
    ...
    $cadena3="[dbo].[FIB_GC_INSERTAPREFICHA_OBSERVACIONES]  '$observaciones','$num_ficha','01','$usuario'";
