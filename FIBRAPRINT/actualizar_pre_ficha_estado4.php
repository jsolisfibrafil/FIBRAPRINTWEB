...
$observa_aprob=$_POST['observa_aprob'];

if ($tipouser=="1"){
    $cadena2="UPDATE [dbo].[@INCODEMOB_PREFICHA]  SET estado='05' , orden_compra='$orden_compra'  WHERE  num_ficha='$num_ficha'" ;
...
if( $exec2 === false ){
    ...
    $cadena3="[dbo].[FIB_GC_INSERTAPREFICHA_OBSERVACIONES]  '$observa_aprob','$num_ficha','05','$usuario'";
