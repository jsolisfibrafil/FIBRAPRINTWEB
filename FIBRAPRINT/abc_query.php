    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Mantenimiento de Query.
            <small></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="inicio.php"><i class="fa fa-dashboard"></i> IncodeMob </a></li>
            <li class="active">Mtto. de Querys</li>
          </ol>
        </section>
          ...
          <div class='row'>
           <div class='col-md-12'>
             <div class='nav-tabs-custom'>
                  ...
                  <li><a href="#bajas" data-toggle="tab">Dar de Baja</a></li>
                  <li class="active"><a href="#altas" data-toggle="tab">Agregar</a></li>

                  <li class="pull-left header"><i class="fa fa-file-text"></i> Operaciones de Query.</li>
                </ul>
               <div class="tab-content">
                  <div class="tab-pane active" id="altas">
                    ...
                    <label for="codigo" class="col-sm-2 control-label">Nombre Query:</label>
                    <div class="col-sm-3">
                    <input type="text" class="form-control" id='nombreq' placeholder='Nombre Query..'>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-3">
						<textarea type="text" class="form-control" id='queryq' placeholder='Consulta...'></textarea>
                    </div>
                    </div>

                    <div class='form-group'>
                    <label for="linea" class="col-sm-2 control-label">Estado:</label>
                    <div class="col-sm-4">
                    <div>
                      <select name="estadoq" id="estadoq" class="form-control">
...
<option value="02">Baja</option>
                  ...
                  <div class="tab-pane" id="bajas">
                    ...
                    <div class='form-group'>
                    <label for="codigo_busqueda" class="col-sm-2 control-label">Codigo Query:</label>
                    <div class="col-sm-3">
                    <input type="text" class="form-control" id='codigo_busqueda' onchange="busca_articulo();" placeholder='Codigo de Query...'>
                    </div>
                    </div>
                  ...
                  <div class="tab-pane" id="cambios">
                    <form class='form-horizontal' onkeypress="return anular(event)">
                    <div class='form-group'>
                    <label for="codigo_busqueda_cambio" class="col-sm-2 control-label">Codigo  Query:</label>
                    <div class="col-sm-3">
                    <input type="text" class="form-control" id='codigo_busqueda_cambio' onchange='busca_articulo_cambio();'  placeholder='Codigo de Query...'>
                    </div>
                    </div>
    ...
    <script src="dist/js/source_admin.js"></script>
    <script>
