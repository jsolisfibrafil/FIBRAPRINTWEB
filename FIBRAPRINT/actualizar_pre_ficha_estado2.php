...
$observacion_env=$_POST['observacion_env'];

if ($tipouser=="1"){
    $cadena2="UPDATE [dbo].[@INCODEMOB_PREFICHA]  SET estado='04'   WHERE  num_ficha='$num_ficha'" ;
...
if( $exec2 === false ){
    ...
    $cadena3="[dbo].[FIB_GC_INSERTAPREFICHA_OBSERVACIONES]  '$observacion_env','$num_ficha','04','$usuario'";
